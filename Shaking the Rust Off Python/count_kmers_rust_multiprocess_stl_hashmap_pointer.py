...
def count_kmers_rust_multiprocess_stl_hashmap_pointer(fasta_file: str,
                                                      num_processes: int,
                                                      sequence_chunk: int,
                                                      k: int,
    ...
    results = pool.map(partial(scripts.count_kmers_stl_hashmap_pointer, k=k), sequences)
...
if __name__ == "__main__":
    print("Rust implementation of k-mer counting (multi-process and STL HashMap pointer)")
